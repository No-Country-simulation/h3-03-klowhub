...
export const NavBar = () => {
    ...
    return (
        <nav className="bg-[#1F202699] backdrop-blur-[15px] text-[#D194E2] h-[63px] w-full flex items-center justify-between px-4">
            <div className="flex items-center space-x-4">
                ...
                <div className="hidden md:flex space-x-4">
                    ...
                    <NavItem href="#">Curso y lecciones</NavItem>
                    <NavItem href="#">Appstore</NavItem>
